...
export const SPEAKING_TASK_TYPES: readonly string[] = [
  ...
  "choose-story",
  // Тикет W2-T3: Build a Chat — чат с пропусками (⚡ за формы) + неожиданное
  // событие с выбором реплик (🗣). Решение тикета: весь тип речевой → 🗣
  // (score = формы + реплики, валюта одна — проще и консистентно).
  "build-chat",
  // Тикет W2-T1: One-Minute Challenge — устный рассказ по теме с таймером и
  // грамматическими условиями → награда 🗣.
  "one-minute",
